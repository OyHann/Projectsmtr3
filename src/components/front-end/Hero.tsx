  ...
  return (
    <div className="bg-[#e3edf6] mt-4">
        <div className="container grid md:grid-cols-2 py-8">
            ...
            <div>
                <img className="ml-auto" src="/MeloMB04Phoenix-removebg-preview.png" alt="hero" />
            </div>
        </div>
    </div>
  );
